...
tools\pcsxroo\seed-portable.ps1      bring over BIOS, controls and settings
tools\pcsxroo\smoke-test.ps1 -Bios   verify the whole path (28 checks)
...
| Document | For |
|---|---|
| [docs/pcsxroo/agent-guide.md](docs/pcsxroo/agent-guide.md) | Driving it: recipes, workflows, the traps that cost time |
| [docs/pcsxroo/cli.md](docs/pcsxroo/cli.md) | Every command, argument, result field and error code |
