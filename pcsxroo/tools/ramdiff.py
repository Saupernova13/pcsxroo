...
then filter the whole 32 MB image at once.
    ...
    python pcsxroo/tools/ramdiff.py a.p2s b.p2s --value 0:2 --value 1:1

    # a per-frame counter: went up by exactly 1 between two consecutive states
    python pcsxroo/tools/ramdiff.py a.p2s b.p2s --delta 1

    # anything that changed at all, as floats
    python pcsxroo/tools/ramdiff.py a.p2s b.p2s --changed --type f32
"""
