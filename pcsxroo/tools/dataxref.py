...
through function pointers - as BT3's input readers are.
    ...
    python pcsxroo/tools/dataxref.py 33398C
    python pcsxroo/tools/dataxref.py 333988-333994 --group
    python pcsxroo/tools/dataxref.py 33398C --in 200000-2C0000 --context 6
"""
