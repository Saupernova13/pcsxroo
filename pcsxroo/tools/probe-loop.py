...
game, tell me what changed, we restore and move on.
    ...
    python pcsxroo/tools/probe-loop.py 12BBD0 --list
    python pcsxroo/tools/probe-loop.py 12BBD0 --nop 6
    python pcsxroo/tools/probe-loop.py 12BBD0 --restore
...
def main() -> int:
    ...
    with pine:
        ...
        print("  python pcsxroo/tools/probe-loop.py "
              f"{args.root} --restore")
    return 0
